<template>
    <main class="container">
        ...
        <div class=' col-7 mx-auto mt-3'>
            <router-link to="/inscription"><button  class=' text-white p-2 w-100 border-0 rounded shadow contrastBoutonRouge font-weight-bold'>INSCRIPTION</button></router-link>
        </div>
    </main>
</template>
