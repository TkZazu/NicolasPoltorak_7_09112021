<template>
    <main class="container">
        ...
        <section class="col-12 col-md-8 mt-5 mx-auto p-3 colored rounded">
        ...
        <div v-show="invalid" class="invalidBox m-2" key="invalid">
         ...
         <div class=' col-7 mx-auto mt-4'>
            <router-link to="/#"><button class='contrastBoutonRouge text-white p-2 w-100 border-0 rounded shadow font-weight-bold'>RETOUR A L'ECRAN DE CONNEXION</button></router-link>
        </div>
    </main>
</template>
