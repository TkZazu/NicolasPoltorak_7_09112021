<template>
    <main class="container">    
        <div class="col-12">
            <div class="col-12 ">
                <h1 v-if= 'this.messages.length !== 0' class="col-12 my-2 btn  btn-block colored font-weight-bold" style="cursor:default">Dernières Publications</h1>   
                    ...
                    <div class="card bg-light my-3 class=center-block" style="float:none;">
                        <div class="card-header">
                            <div class="row justify-content-around">
                                <p class="m-1"> <img src="../assets/icon.png" alt="iconMember" style="height: 35px; width: 35px"/> Bonjour {{ name }} ! </p>
                        ...
                        <div class="card-body">
                            ...
                            <div id="compteButton" class="text-center">
                                ...
                                <router-link v-else to='/Compte'><button type="button" class=" btn colored mx-auto rounded p-2 buttonsPanel">COMPTE</button></router-link> 
                            </div>
                        </div>
